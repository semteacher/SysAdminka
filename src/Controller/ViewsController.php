    ...
    public function helsi(){
        ...
        if ($this->request->is('post')) {
            ...
            $data= $data->select([
                ...
                '"Навчальний заклад"' =>'"Тернопільський національний медичний університет"',
                ...
                '"Категорія"' =>'"Вища"',
                '"Спеціальність (атестація)"' =>'"Терапія"',
                '"Номер наказу"' =>'"111-1"',
                '"Дата наказу"' =>'"01.08.2021"',
                '"Видавник наказу"' =>'"Департамент ОЗ Тернопільської ОДА"',
                '"Дата атестації"' =>'"01.09.2021"',
                '"Термін атестації по:"' =>'"01.09.2041"',
