...
<!--        </div>-->
    ...
    <table
        ...
        <tr>
            ...
            <th style="max-width:100px" class="hidden-xs hidden-sm" data-filterable="text" data-sortable="true" data-sort-order="2">IPN</th>
    ...
    <?php foreach ($students as $student): ?>
        <tr <?= $viev_photo_students==1 ? ' class="popover_students" data-toggle="popover" img="'.$student->user_name.'" ' : '' ?>>
            ...
            <td class='hidden-xs hidden-sm'><?= $this->Text->autoParagraph(h($student->ipn_id)); ?></td>
